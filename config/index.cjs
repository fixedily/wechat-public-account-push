...
const USER_CONFIG = {
  ...
  USERS: [
    ...
    },
    {
      ...
      id: 'oocL-17TyDcglLvLfyQzpoahDBbI',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: 'gUf0cOTwvmX8vyhLz-WMWbLX3j_odl7DaXsxegQXYA8',
    },
  ],

  TIAN_API: {
    // 天行API KEY，如果使用天行API则需要填写此项
    key: '7a8c19e19bb406b9f1fd0a3ecd752f28',
  ...
  CALLBACK_TEMPLATE_ID: '2hsfLHcYXRe2WUOdbbLrsw2mUf1VJZENVDl2LPNtnLE',
